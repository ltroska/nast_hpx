        ...
        )
{
    ...
    if (cell_type == std::bitset<5>("00111"))
        ...
        case 1: middle.value =
                    ...
                    break;            
        case 2: middle.value =
                    right.value + dx*temperature_boundary_data.left*((j-0.5)*dy);
                    break;
        }
    ...
    if (cell_type == std::bitset<5>("01011"))
        ...
        case 1: middle.value = 2*temperature_boundary_data.right - left.value;
                break;            
        case 2: middle.value =
                    left.value + dx*temperature_boundary_data.right*((j-0.5)*dy);
                    break;
        }
    ...
    if (cell_type == std::bitset<5>("01110"))
        ...
        case 1: middle.value = 2*temperature_boundary_data.bottom - top.value;
                break;            
        case 2: middle.value =
                    top.value + dy*temperature_boundary_data.bottom*((i-0.5)*dx);
                    break;
        }
    ...
    if (cell_type == std::bitset<5>("01101"))
        ...
        case 1: middle.value = 2*temperature_boundary_data.top - bottom.value;
                break;            
        case 2: middle.value =
                    bottom.value + dy*temperature_boundary_data.top*((i-0.5)*dx);
                    break;
        }    
}
