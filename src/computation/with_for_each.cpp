    ...
    return hpx::dataflow(
        ...
        hpx::util::unwrapped(
            ...
            -> vector_partition
            {
                ...
                {
                    if (type.top == 1)
                        next.get_cell_ref(size_x - 2, size_y - 1).first =
                    ...
                    if (type.right == 1)
                        next.get_cell_ref(size_x - 1, size_y - 2).second =
            ...
            -> scalar_partition
            {
                ...
                hpx::parallel::for_each(
                    ...
                    [&](uint cnt)
                    {
                        ...
                        scalar_cell& middle = next.get_cell_ref(i, j);
        ...
        hpx::util::unwrapped(
            ...
            -> vector_partition
            {
                ...
                [&](uint cnt)
                {
                    ...
                    compute_fg_for_cell(
                        next.get_cell_ref(i, j), m_uv.get_cell(i, j),
            ...
            -> std::pair<vector_partition, std::pair<RealType, RealType> >
            {
                ...
                vector_cell max_uv = hpx::parallel::transform_reduce(
                        ...
                        -> vector_cell
                    {
                        ...
                        vector_cell& middle_uv = next.get_cell_ref(i, j);
