...
namespace nast_hpx { namespace grid {
    ...
    struct pack_buffer<LEFT>
    {
        ...
        static void call(partition_data<double> const& p, BufferType& buffer, std::size_t y, std::size_t z,
                            std::size_t cells_y_per_block, std::size_t cells_z_per_block)
        {
            buffer = BufferType(new double[cells_y_per_block * cells_z_per_block],
                                    cells_y_per_block * cells_z_per_block, BufferType::take, util::array_deleter<double>());
    ...
    {
        template <typename BufferType>
        static void call(partition_data<double> const& p, BufferType& buffer, std::size_t x, std::size_t y,
                            std::size_t cells_x_per_block, std::size_t cells_y_per_block)
        {
            buffer = BufferType(new double[cells_x_per_block * cells_y_per_block],
                                    cells_x_per_block * cells_y_per_block, BufferType::take, util::array_deleter<double>());
    ...
    {
        template <typename BufferType>
        static void call(partition_data<double> const& p, BufferType& buffer, std::size_t x, std::size_t z,
                            std::size_t cells_x_per_block, std::size_t cells_z_per_block)
        {
            buffer = BufferType(new double[cells_x_per_block * cells_z_per_block],
                                    cells_x_per_block * cells_z_per_block, BufferType::take, util::array_deleter<double>());
    ...
    {
        template <typename BufferType>
        static void call(partition_data<double> const& p, BufferType& buffer, std::size_t z, std::size_t bogus,
                            std::size_t cells_z_per_block, std::size_t bogus2)
        {
            buffer = BufferType(new double[cells_z_per_block],
                                    cells_z_per_block, BufferType::take, util::array_deleter<double>());
    ...
    {
        template <typename BufferType>
        static void call(partition_data<double> const& p, BufferType& buffer, std::size_t y, std::size_t bogus,
                            std::size_t cells_y_per_block, std::size_t bogus2)
        {
            buffer = BufferType(new double[cells_y_per_block],
                                    cells_y_per_block, BufferType::take, util::array_deleter<double>());
    ...
    {
        template <typename BufferType>
        static void call(partition_data<double> const& p, BufferType& buffer, std::size_t x, std::size_t bogus,
                            std::size_t cells_x_per_block, std::size_t bogus2)
        {
            buffer = BufferType(new double[cells_x_per_block],
                                    cells_x_per_block, BufferType::take, util::array_deleter<double>());
