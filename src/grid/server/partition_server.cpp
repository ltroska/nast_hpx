                ...
                hpx::shared_future<void> calc_future =
                    hpx::async(
                        hpx::util::bind(
                            ...
                            obstacle_cells_(nx_block, ny_block, nz_block).begin(),
         ...
         for (std::size_t nz_block = 0; nz_block < c.num_z_blocks; ++nz_block)
            ...
            for (std::size_t nz_block = 0; nz_block < c.num_z_blocks; ++nz_block)
                for (std::size_t ny_block = 0; ny_block < c.num_y_blocks; ++ny_block)
                    for (std::size_t nx_block = 0; nx_block < c.num_x_blocks; ++nx_block)
                    {
                        hpx::shared_future<double> calc_future =
                            hpx::dataflow(
                                hpx::util::unwrapped(
                                    hpx::util::bind(
            ...
            hpx::future<double> local_residual =
                ...
                if (c.rank == 0)
                {
                    ...
                    residual.then(
                        hpx::util::unwrapped(
                            [dt, iter_int = iter, step = step_, t = t_, this](double residual)
                            {
