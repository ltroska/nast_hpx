...
// --- SQUARE AREA, ONE PARTITION --- //
    do_update_velocities_test(6, 6, 0, 1, 1, 8, 8);
    do_update_velocities_test(62, 62, 0, 1, 1, 64, 64);

// --- SQUARE AREA, MULTIPLE PARTITIONS --- //
    do_update_velocities_test(62, 62, 0, 1, 1, 8, 8);
    do_update_velocities_test(64, 64, 0, 1, 1, 8, 16);
    do_update_velocities_test(64, 64, 0, 1, 1, 16, 8);
    do_update_velocities_test(64, 64, 0, 1, 1, 32, 8);

// --- SQUARE AREA, MULTIPLE PARTITIONS, NOT FIRST LOCALITY --- //
    do_update_velocities_test(30, 30, 2, 2, 2, 8, 8);
    do_update_velocities_test(254, 254, 1, 1, 2, 128, 64);
    do_update_velocities_test(254, 254, 1, 2, 1, 128, 64);
